    ...
    <div className="min-h-screen bg-gray-50 pt-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="relative w-96 h-96 mx-auto">
                  ...
                  {/* Sparkle Icons */}
                  <div className="absolute -bottom-4 -left-4 w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                    </svg>
                  </div>
                  <div className="absolute -bottom-2 -left-8 w-6 h-6 bg-yellow-400 rounded-full flex items-center justify-center">
              ...
              <div className="space-y-6">
                <div>
                  <p className="text-sm text-gray-500 uppercase tracking-wide mb-2">About Us</p>
                ...
                {/* Signature */}
                <div className="pt-4">
                  <p className="text-2xl font-cursive text-gray-700">Joey Alexander</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <Container>
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <p className="text-sm text-gray-500 uppercase tracking-wide mb-2">Our Team</p>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8">
                Meet The Passionate Team Behind Our Success
              </h2>
              
              {/* Team Statistics Bar */}
              <div className="bg-green-800 rounded-2xl p-6 max-w-4xl mx-auto">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                  ...
                  <div>
                    ...
                    <div className="text-green-200 text-sm">Years of Experience</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white mb-1">99%</div>
                    <div className="text-green-200 text-sm">Satisfied Customers</div>
                  ...
                  <div>
                    ...
                    <div className="text-green-200 text-sm">Plants Delivered</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1">Jenny Alexander</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1">Rosie Cooper</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1">Jane Cooper</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1">Robert Fox</h3>
                <p className="text-sm text-gray-600">Inventory Specialist</p>
              </div>
        ...
        <Container>
          <div className="flex items-center justify-center overflow-x-auto">
            <div className="flex items-center gap-8 whitespace-nowrap">
              <div className="flex items-center gap-2 text-gray-800 hover:text-green-700 transition-colors cursor-pointer">
              ...
              <div className="flex items-center gap-2 text-gray-800 hover:text-green-700 transition-colors cursor-pointer">
                ...
                <span className="font-medium">Office Desk Plants</span>
              </div>
              <div className="flex items-center gap-2 text-gray-800 hover:text-green-700 transition-colors cursor-pointer">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                </svg>
                <span className="font-medium">Pots & Accessories</span>
              </div>
              <div className="flex items-center gap-2 text-gray-800 hover:text-green-700 transition-colors cursor-pointer">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                </svg>
                <span className="font-medium">Gift Plants & Combos</span>
              </div>
            </div>
          </div>
        </Container>
      ...
      <Section className="bg-gray-50 py-16">
        <Container>
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <p className="text-sm text-gray-500 uppercase tracking-wide mb-2">Testimonial</p>
      ...
      <Section className="bg-white py-16">
        <Container>
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <p className="text-sm text-gray-500 uppercase tracking-wide mb-2">Follow Us</p>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
